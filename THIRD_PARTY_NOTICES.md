...
KVCacheBench uses or references outputs derived from public benchmark and
library ecosystems. Please follow the upstream licenses and terms for any
regenerated raw data or full reruns.
...
This repository does not vendor full upstream datasets or model weights.
